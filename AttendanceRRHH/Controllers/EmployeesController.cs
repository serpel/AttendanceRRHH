...
namespace AttendanceRRHH.Controllers
{
    ...
    public class EmployeesController : BaseController
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.JobPositionId = new SelectList(db.Jobs.Where(w => companies.Contains((int)w.CompanyId)).Select(s => new { s.JobPositionId, Name = s.Company.Name.Substring(0, 3).ToUpper() + " - " + s.JobTitle }), "JobPositionId", "Name");
        ...
        public ActionResult Create([Bind(Include = "EmployeeId,EmployeeCode,NationalCardId,FirstName,LastName,Address,Bithdate,Gender,PhoneNumber,ProfileUrl,HireDate,DepartmentId,ShiftId,JobPositionId,CountryId,CityId,IsActive,IsExtraHourPay")] Employee employee, HttpPostedFileBase file)
        {
            ...
            ViewBag.JobPositionId = new SelectList(db.Jobs.Where(w => companies.Contains((int)w.CompanyId)).Select(s => new { s.JobPositionId, Name = s.Company.Name.Substring(0, 3).ToUpper() + " - " + s.JobTitle }), "JobPositionId", "Name", employee.JobPositionId);
